      ...
      <div className="w-full max-w-md">
        ...
        <CardFooter className="px-6 md:px-8 pb-8 flex justify-center border-t border-slate-50 pt-6">
          <p className="text-sm text-slate-500">
            Sudah punya akun? <Link to="/login" className="text-blue-600 font-semibold hover:text-blue-700 hover:underline transition-colors cursor-pointer">Masuk di sini</Link>
          </p>
        </CardFooter>
      </Card>
    </div>
